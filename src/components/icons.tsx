...
export const Logo: React.FC<IconSvgProps> = ({
  ...
  >
    ...
    >
      ...
      <path d="M22 12c0-1.66-1.46-3-3.25-3c-1.8 0-3.25 1.34-3.25 3c0-1.66-1.57-3-3.5-3s-3.5 1.34-3.5 3c0-1.66-1.46-3-3.25-3C3.45 9 2 10.34 2 12m0 0l10 10l-3.5-10m7 0L12 22l10-10" />
    </g>
  </svg>
);

export const CirclePlusIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const CircleMinusIcon: React.FC<IconSvgProps> = ({
  size = 24,
  width,
  height,
  ...props
...
export const DownArrowIcon: React.FC<IconSvgProps> = ({
  ...
  return (
    ...
    >
      <path
        d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m0 12l-4-4h8z"
        fill="currentColor"
      />
    </svg>
  );
